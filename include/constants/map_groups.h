...
#define MAP_MEGA_STONE_CAVE                          (108 | (24 << 8))
...
// static const u8 MAP_GROUP_COUNT[] = {59, 5, 5, 6, 7, 8, 9, 7, 7, 14, 8, 17, 10, 23, 13, 15, 15, 2, 2, 2, 3, 1, 1, 1, 109, 61, 89, 2, 1, 13, 1, 1, 3, 1, 0};
