...
static const u8 sText_PkmnAfflictedBySplinters[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt by\nSPLINTERS");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNAFFLICTEDBYSPLINTERS - BATTLESTRINGS_TABLE_START] = sText_PkmnAfflictedBySplinters,
};
