...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_TORTERRA]   = BACK_ANIM_H_SHAKE,
    [SPECIES_CHIMCHAR]   = BACK_ANIM_H_STRETCH,
    [SPECIES_MONFERNO]   = BACK_ANIM_H_STRETCH,//
    [SPECIES_INFERNAPE]  = BACK_ANIM_H_STRETCH,//
    [SPECIES_PIPLUP]     = BACK_ANIM_V_STRETCH,
    [SPECIES_PRINPLUP]   = BACK_ANIM_H_STRETCH,//
    [SPECIES_EMPOLEON]   = BACK_ANIM_H_STRETCH,//
    [SPECIES_STARLY]     = BACK_ANIM_V_STRETCH,
    [SPECIES_STARAVIA]   = BACK_ANIM_V_STRETCH,//
    [SPECIES_STARAPTOR]  = BACK_ANIM_V_STRETCH,//
    [SPECIES_LOPUNNY]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GLAMEOW]    = BACK_ANIM_V_STRETCH,
    [SPECIES_PURUGLY]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_BRONZOR]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CHATOT]     = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_SPIRITOMB]  = BACK_ANIM_H_STRETCH,
    [SPECIES_GARCHOMP]   = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_HIPPOPOTAS] = BACK_ANIM_V_STRETCH,
    [SPECIES_UXIE]       = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_MESPRIT]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_AZELF]      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DIALGA]     = BACK_ANIM_V_SHAKE,
    [SPECIES_PALKIA]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_REGIGIGAS]  = BACK_ANIM_H_SHAKE,
    [SPECIES_GIRATINA]   = BACK_ANIM_H_SHAKE,
    [SPECIES_CRESSELIA]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_PHIONE]     = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_MANAPHY]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DARKRAI]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_SHAYMIN]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ARCEUS]     = BACK_ANIM_H_VIBRATE,

    // Gen 5
    [SPECIES_VICTINI]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_SNIVY]      = BACK_ANIM_V_STRETCH,
    [SPECIES_SERVINE]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SERPERIOR]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_TEPIG]      = BACK_ANIM_SHRINK_GROW,
    [SPECIES_PIGNITE]    = BACK_ANIM_H_SLIDE,
    [SPECIES_EMBOAR]     = BACK_ANIM_V_SHAKE,
    [SPECIES_OSHAWOTT]   = BACK_ANIM_H_SLIDE,
    [SPECIES_DEWOTT]     = BACK_ANIM_H_STRETCH,
    [SPECIES_SAMUROTT]   = BACK_ANIM_GROW,
    [SPECIES_PATRAT]     = BACK_ANIM_H_SLIDE,
    [SPECIES_WATCHOG]    = BACK_ANIM_GROW_STUTTER,
    [SPECIES_LILLIPUP]   = BACK_ANIM_V_STRETCH,
    [SPECIES_HERDIER]    = BACK_ANIM_V_STRETCH,
    [SPECIES_STOUTLAND]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_PURRLOIN]   = BACK_ANIM_V_STRETCH,
    [SPECIES_LIEPARD]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_PANSAGE]    = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_SIMISAGE]   = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_PANSEAR]    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_SIMISEAR]   = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_PANPOUR]    = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_SIMIPOUR]   = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_MUNNA]      = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MUSHARNA]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_PIDOVE]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_TRANQUILL]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_UNFEZANT]   = BACK_ANIM_V_STRETCH,
    [SPECIES_BLITZLE]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_ZEBSTRIKA]  = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_ROGGENROLA] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_BOLDORE]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_GIGALITH]   = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_WOOBAT]     = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_SWOOBAT]    = BACK_ANIM_H_SLIDE,
    [SPECIES_DRILBUR]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_EXCADRILL]  = BACK_ANIM_SHRINK_GROW,
    [SPECIES_AUDINO]     = BACK_ANIM_H_SLIDE,
    [SPECIES_TIMBURR]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_GURDURR]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_CONKELDURR] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_TYMPOLE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_PALPITOAD]  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_SEISMITOAD] = BACK_ANIM_GROW_STUTTER,
    [SPECIES_THROH]      = BACK_ANIM_H_STRETCH,
    [SPECIES_SAWK]       = BACK_ANIM_V_STRETCH,
    [SPECIES_SEWADDLE]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SWADLOON]   = BACK_ANIM_SHRINK_GROW,
    [SPECIES_LEAVANNY]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_VENIPEDE]   = BACK_ANIM_H_SLIDE,
    [SPECIES_WHIRLIPEDE] = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_SCOLIPEDE]  = BACK_ANIM_GROW_STUTTER,
    [SPECIES_COTTONEE]   = BACK_ANIM_H_SLIDE,
    [SPECIES_WHIMSICOTT] = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_PETILIL]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_LILLIGANT]  = BACK_ANIM_H_SLIDE,
    [SPECIES_BASCULIN]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SANDILE]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_KROKOROK]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_KROOKODILE] = BACK_ANIM_GROW,
    [SPECIES_DARUMAKA]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DARMANITAN] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_MARACTUS]   = BACK_ANIM_H_SPRING,
    [SPECIES_DWEBBLE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_CRUSTLE]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_SCRAGGY]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_SCRAFTY]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SIGILYPH]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_YAMASK]     = BACK_ANIM_SHRINK_GROW,
    [SPECIES_COFAGRIGUS] = BACK_ANIM_H_SHAKE,
    [SPECIES_TIRTOUGA]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CARRACOSTA] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_ARCHEN]     = BACK_ANIM_V_STRETCH,
    [SPECIES_ARCHEOPS]   = BACK_ANIM_GROW,
    [SPECIES_TRUBBISH]   = BACK_ANIM_H_SLIDE,
    [SPECIES_GARBODOR]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ZORUA]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ZOROARK]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_MINCCINO]   = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_CINCCINO]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_GOTHITA]    = BACK_ANIM_H_SLIDE,
    [SPECIES_GOTHORITA]  = BACK_ANIM_SHRINK_GROW,
    [SPECIES_GOTHITELLE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_SOLOSIS]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DUOSION]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_REUNICLUS]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DUCKLETT]   = BACK_ANIM_V_STRETCH,
    [SPECIES_SWANNA]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_VANILLITE]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_VANILLISH]  = BACK_ANIM_H_SHAKE,
    [SPECIES_VANILLUXE]  = BACK_ANIM_H_SLIDE,
    [SPECIES_DEERLING]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SAWSBUCK]   = BACK_ANIM_V_STRETCH,
    ...
    [SPECIES_FOONGUS]    = BACK_ANIM_H_STRETCH,
    [SPECIES_AMOONGUSS]  = BACK_ANIM_GROW,
    [SPECIES_FRILLISH]   = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_JELLICENT]  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_ALOMOMOLA]  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_JOLTIK]     = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_GALVANTULA] = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_FERROSEED]  = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_FERROTHORN] = BACK_ANIM_V_STRETCH,
    [SPECIES_KLINK]      = BACK_ANIM_GROW_STUTTER,
    [SPECIES_KLANG]      = BACK_ANIM_V_SHAKE,
    [SPECIES_KLINKLANG]  = BACK_ANIM_H_SLIDE,
    [SPECIES_TYNAMO]     = BACK_ANIM_H_SLIDE,
    [SPECIES_EELEKTRIK]  = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_EELEKTROSS] = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_ELGYEM]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_BEHEEYEM]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_LITWICK]    = BACK_ANIM_V_STRETCH,
    [SPECIES_LAMPENT]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_CHANDELURE] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_AXEW]       = BACK_ANIM_SHRINK_GROW,
    [SPECIES_FRAXURE]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_HAXORUS]    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_CUBCHOO]    = BACK_ANIM_H_SLIDE,
    [SPECIES_BEARTIC]    = BACK_ANIM_H_SHAKE,
    [SPECIES_CRYOGONAL]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SHELMET]    = BACK_ANIM_H_STRETCH,
    [SPECIES_ACCELGOR]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_STUNFISK]   = BACK_ANIM_GROW_STUTTER,
    [SPECIES_MIENFOO]    = BACK_ANIM_H_SLIDE,
    [SPECIES_MIENSHAO]   = BACK_ANIM_GROW_STUTTER,
    [SPECIES_DRUDDIGON]  = BACK_ANIM_GROW_STUTTER,
    [SPECIES_GOLETT]     = BACK_ANIM_H_SHAKE,
    [SPECIES_GOLURK]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_PAWNIARD]   = BACK_ANIM_H_SLIDE,
    [SPECIES_BISHARP]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_BOUFFALANT] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_RUFFLET]    = BACK_ANIM_V_STRETCH,
    [SPECIES_BRAVIARY]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_VULLABY]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MANDIBUZZ]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_HEATMOR]    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_DURANT]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DEINO]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ZWEILOUS]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_HYDREIGON]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_LARVESTA]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_VOLCARONA]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_COBALION]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_TERRAKION]  = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_VIRIZION]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_TORNADUS]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_THUNDURUS]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_RESHIRAM]   = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_ZEKROM]     = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_LANDORUS]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_KYUREM]     = BACK_ANIM_H_SHAKE,
    [SPECIES_KELDEO]     = BACK_ANIM_V_STRETCH,
    [SPECIES_MELOETTA]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GENESECT]   = BACK_ANIM_H_VIBRATE,

    // Gen 6
    [SPECIES_CHESPIN]    = BACK_ANIM_V_STRETCH,
    [SPECIES_QUILLADIN]  = BACK_ANIM_V_STRETCH,
    [SPECIES_CHESNAUGHT] = BACK_ANIM_V_STRETCH,
    [SPECIES_FENNEKIN]   = BACK_ANIM_V_STRETCH,
    [SPECIES_BRAIXEN]    = BACK_ANIM_V_STRETCH,
    [SPECIES_DELPHOX]    = BACK_ANIM_V_STRETCH,
    [SPECIES_FROAKIE]    = BACK_ANIM_H_STRETCH,
    [SPECIES_FROGADIER]  = BACK_ANIM_V_STRETCH,
    [SPECIES_GRENINJA]   = BACK_ANIM_V_STRETCH,
    [SPECIES_BUNNELBY]   = BACK_ANIM_V_STRETCH,
    [SPECIES_DIGGERSBY]  = BACK_ANIM_V_STRETCH,
    [SPECIES_FLETCHLING] = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_FLETCHINDER] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_TALONFLAME] = BACK_ANIM_GROW,
    [SPECIES_SCATTERBUG] = BACK_ANIM_V_STRETCH,
    [SPECIES_SPEWPA]     = BACK_ANIM_V_STRETCH,
    [SPECIES_VIVILLON]   = BACK_ANIM_V_STRETCH,
    [SPECIES_LITLEO]     = BACK_ANIM_V_STRETCH,
    [SPECIES_PYROAR]     = BACK_ANIM_V_STRETCH,
    [SPECIES_FLABEBE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_FLOETTE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_FLORGES]    = BACK_ANIM_V_STRETCH,
    [SPECIES_SKIDDO]     = BACK_ANIM_V_STRETCH,
    [SPECIES_GOGOAT]     = BACK_ANIM_V_STRETCH,
    [SPECIES_PANCHAM]    = BACK_ANIM_V_STRETCH,
    [SPECIES_PANGORO]    = BACK_ANIM_V_STRETCH,
    [SPECIES_FURFROU]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ESPURR]     = BACK_ANIM_V_STRETCH,
    [SPECIES_MEOWSTIC]   = BACK_ANIM_V_STRETCH,
    [SPECIES_HONEDGE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_DOUBLADE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_AEGISLASH]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SPRITZEE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_AROMATISSE] = BACK_ANIM_V_STRETCH,
    [SPECIES_SWIRLIX]    = BACK_ANIM_V_STRETCH,
    [SPECIES_SLURPUFF]   = BACK_ANIM_V_STRETCH,
    [SPECIES_INKAY]      = BACK_ANIM_V_STRETCH,
    [SPECIES_MALAMAR]    = BACK_ANIM_V_STRETCH,
    [SPECIES_BINACLE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_BARBARACLE] = BACK_ANIM_V_STRETCH,
    [SPECIES_SKRELP]     = BACK_ANIM_V_STRETCH,
    [SPECIES_DRAGALGE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_CLAUNCHER]  = BACK_ANIM_V_STRETCH,
    [SPECIES_CLAWITZER]  = BACK_ANIM_V_STRETCH,
    [SPECIES_HELIOPTILE] = BACK_ANIM_V_STRETCH,
    [SPECIES_HELIOLISK]  = BACK_ANIM_V_STRETCH,
    [SPECIES_TYRUNT]     = BACK_ANIM_V_STRETCH,
    [SPECIES_TYRANTRUM]  = BACK_ANIM_V_STRETCH,
    [SPECIES_AMAURA]     = BACK_ANIM_V_STRETCH,
    [SPECIES_AURORUS]    = BACK_ANIM_V_STRETCH,
    [SPECIES_SYLVEON]    = BACK_ANIM_V_STRETCH,
    [SPECIES_HAWLUCHA]   = BACK_ANIM_V_STRETCH,
    [SPECIES_DEDENNE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_CARBINK]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GOOMY]      = BACK_ANIM_V_STRETCH,
    [SPECIES_SLIGGOO]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GOODRA]     = BACK_ANIM_V_STRETCH,
    [SPECIES_KLEFKI]     = BACK_ANIM_V_STRETCH,
    [SPECIES_PHANTUMP]   = BACK_ANIM_V_STRETCH,
    [SPECIES_TREVENANT]  = BACK_ANIM_V_STRETCH,
    [SPECIES_PUMPKABOO]  = BACK_ANIM_V_STRETCH,
    [SPECIES_GOURGEIST]  = BACK_ANIM_V_STRETCH,
    [SPECIES_BERGMITE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_AVALUGG]    = BACK_ANIM_V_STRETCH,
    [SPECIES_NOIBAT]     = BACK_ANIM_V_STRETCH,
    [SPECIES_NOIVERN]    = BACK_ANIM_V_STRETCH,
    [SPECIES_XERNEAS]    = BACK_ANIM_V_STRETCH,
    [SPECIES_YVELTAL]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ZYGARDE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_DIANCIE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_HOOPA]      = BACK_ANIM_V_STRETCH,
    [SPECIES_VOLCANION]  = BACK_ANIM_V_STRETCH,
    ...
    [SPECIES_LITTEN]     = BACK_ANIM_V_STRETCH,
    [SPECIES_TORRACAT]   = BACK_ANIM_V_STRETCH,
    [SPECIES_INCINEROAR] = BACK_ANIM_V_STRETCH,
    [SPECIES_POPPLIO]    = BACK_ANIM_V_STRETCH,
    [SPECIES_BRIONNE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_PRIMARINA]  = BACK_ANIM_V_STRETCH,
    [SPECIES_PIKIPEK]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_TRUMBEAK]   = BACK_ANIM_H_STRETCH,
    [SPECIES_TOUCANNON]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_YUNGOOS]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GUMSHOOS]   = BACK_ANIM_V_STRETCH,
    [SPECIES_CUTIEFLY]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_RIBOMBEE]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROCKRUFF]   = BACK_ANIM_V_STRETCH,
    [SPECIES_LYCANROC]   = BACK_ANIM_V_SHAKE,
    [SPECIES_STUFFUL]    = BACK_ANIM_H_STRETCH,
    [SPECIES_ORANGURU]   = BACK_ANIM_H_SLIDE,
    [SPECIES_PASSIMIAN]  = BACK_ANIM_H_SHAKE,
    [SPECIES_JANGMO_O]   = BACK_ANIM_H_STRETCH,
    [SPECIES_HAKAMO_O]   = BACK_ANIM_H_STRETCH,
    [SPECIES_KOMMO_O]    = BACK_ANIM_H_SHAKE,
    [SPECIES_TAPU_KOKO]  = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_TAPU_LELE]  = BACK_ANIM_SHAKE_GLOW_BLUE,

    // Gen 8
    [SPECIES_GROOKEY]    = BACK_ANIM_V_STRETCH,
    [SPECIES_THWACKEY]   = BACK_ANIM_V_STRETCH,
    [SPECIES_RILLABOOM]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SCORBUNNY]  = BACK_ANIM_V_STRETCH,
    [SPECIES_RABOOT]     = BACK_ANIM_V_STRETCH,
    [SPECIES_CINDERACE]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SOBBLE]     = BACK_ANIM_V_STRETCH,
    [SPECIES_DRIZZILE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_INTELEON]   = BACK_ANIM_V_STRETCH,
    [SPECIES_SKWOVET]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GREEDENT]   = BACK_ANIM_V_STRETCH,
    [SPECIES_ROOKIDEE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_CORVISQUIRE] = BACK_ANIM_V_STRETCH,
    [SPECIES_CORVIKNIGHT] = BACK_ANIM_V_STRETCH,
    [SPECIES_BLIPBUG]    = BACK_ANIM_V_STRETCH,
    [SPECIES_DOTTLER]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ORBEETLE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_NICKIT]     = BACK_ANIM_V_STRETCH,
    [SPECIES_THIEVUL]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GOSSIFLEUR] = BACK_ANIM_V_STRETCH,
    [SPECIES_ELDEGOSS]   = BACK_ANIM_V_STRETCH,
    [SPECIES_WOOLOO]     = BACK_ANIM_V_STRETCH,
    [SPECIES_DUBWOOL]    = BACK_ANIM_V_STRETCH,
    [SPECIES_CHEWTLE]    = BACK_ANIM_V_STRETCH,
    [SPECIES_DREDNAW]    = BACK_ANIM_V_STRETCH,
    [SPECIES_YAMPER]     = BACK_ANIM_V_STRETCH,
    [SPECIES_BOLTUND]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ROLYCOLY]   = BACK_ANIM_V_STRETCH,
    [SPECIES_CARKOL]     = BACK_ANIM_V_STRETCH,
    [SPECIES_COALOSSAL]  = BACK_ANIM_V_STRETCH,
    [SPECIES_APPLIN]     = BACK_ANIM_V_STRETCH,
    [SPECIES_FLAPPLE]    = BACK_ANIM_H_SLIDE,
    [SPECIES_APPLETUN]   = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SILICOBRA]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SANDACONDA] = BACK_ANIM_V_STRETCH,
    [SPECIES_CRAMORANT]  = BACK_ANIM_V_STRETCH,
    [SPECIES_ARROKUDA]   = BACK_ANIM_V_STRETCH,
    [SPECIES_BARRASKEWDA] = BACK_ANIM_V_STRETCH,
    [SPECIES_TOXEL]      = BACK_ANIM_V_STRETCH,
    [SPECIES_TOXTRICITY] = BACK_ANIM_V_STRETCH,
    [SPECIES_SIZZLIPEDE] = BACK_ANIM_V_STRETCH,
    [SPECIES_CENTISKORCH] = BACK_ANIM_V_STRETCH,
    [SPECIES_CLOBBOPUS]  = BACK_ANIM_V_STRETCH,
    [SPECIES_GRAPPLOCT]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SINISTEA]   = BACK_ANIM_V_STRETCH,
    [SPECIES_POLTEAGEIST] = BACK_ANIM_V_STRETCH,
    [SPECIES_HATENNA]    = BACK_ANIM_V_STRETCH,
    [SPECIES_HATTREM]    = BACK_ANIM_V_STRETCH,
    [SPECIES_HATTERENE]  = BACK_ANIM_V_STRETCH,
    [SPECIES_IMPIDIMP]   = BACK_ANIM_V_STRETCH,
    [SPECIES_MORGREM]    = BACK_ANIM_V_STRETCH,
    [SPECIES_GRIMMSNARL] = BACK_ANIM_V_STRETCH,
    [SPECIES_OBSTAGOON]  = BACK_ANIM_V_STRETCH,
    [SPECIES_PERRSERKER] = BACK_ANIM_V_STRETCH,
    [SPECIES_CURSOLA]    = BACK_ANIM_V_STRETCH,
    [SPECIES_SIRFETCHD]  = BACK_ANIM_V_STRETCH,
    [SPECIES_MR_RIME]    = BACK_ANIM_V_STRETCH,
    [SPECIES_RUNERIGUS]  = BACK_ANIM_V_STRETCH,
    [SPECIES_MILCERY]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ALCREMIE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_FALINKS]    = BACK_ANIM_V_STRETCH,
    [SPECIES_PINCURCHIN] = BACK_ANIM_V_STRETCH,
    [SPECIES_SNOM]       = BACK_ANIM_V_STRETCH,
    [SPECIES_FROSMOTH]   = BACK_ANIM_V_STRETCH,
    [SPECIES_STONJOURNER] = BACK_ANIM_V_STRETCH,
    [SPECIES_EISCUE]     = BACK_ANIM_V_STRETCH,
    [SPECIES_INDEEDEE]   = BACK_ANIM_V_STRETCH,
    [SPECIES_MORPEKO]    = BACK_ANIM_V_STRETCH,
    [SPECIES_CUFANT]     = BACK_ANIM_V_STRETCH,
    [SPECIES_COPPERAJAH] = BACK_ANIM_V_STRETCH,
    [SPECIES_DRACOZOLT]  = BACK_ANIM_V_STRETCH,
    [SPECIES_ARCTOZOLT]  = BACK_ANIM_V_STRETCH,
    [SPECIES_DRACOVISH]  = BACK_ANIM_H_SHAKE,
    [SPECIES_ARCTOVISH]  = BACK_ANIM_V_STRETCH,
    [SPECIES_DURALUDON]  = BACK_ANIM_V_STRETCH,
    [SPECIES_DREEPY]     = BACK_ANIM_H_SLIDE,
    [SPECIES_DRAKLOAK]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DRAGAPULT]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ZACIAN]     = BACK_ANIM_V_STRETCH,
    [SPECIES_ZAMAZENTA]  = BACK_ANIM_V_STRETCH,
    [SPECIES_ETERNATUS]  = BACK_ANIM_V_STRETCH,
    [SPECIES_KUBFU]      = BACK_ANIM_V_STRETCH,
    [SPECIES_URSHIFU]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ZARUDE]     = BACK_ANIM_V_STRETCH,
    [SPECIES_REGIELEKI]  = BACK_ANIM_V_STRETCH,
    [SPECIES_REGIDRAGO]  = BACK_ANIM_V_STRETCH,
    [SPECIES_GLASTRIER]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SPECTRIER]  = BACK_ANIM_V_STRETCH,
    [SPECIES_CALYREX]    = BACK_ANIM_V_STRETCH,
    ...
    [SPECIES_BASCULEGION] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SNEASLER]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_OVERQWIL]    = BACK_ANIM_CONVEX_DOUBLE_ARC,

    // Forms
    [SPECIES_DEERLING_SUMMER]      = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DEERLING_AUTUMN]      = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DEERLING_WINTER]      = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SAWSBUCK_SUMMER]      = BACK_ANIM_V_STRETCH,
    [SPECIES_SAWSBUCK_AUTUMN]      = BACK_ANIM_V_STRETCH,
    [SPECIES_SAWSBUCK_WINTER]      = BACK_ANIM_V_STRETCH,
    [SPECIES_KYUREM_WHITE]         = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_KYUREM_BLACK]         = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_KELDEO_RESOLUTE]      = BACK_ANIM_V_STRETCH,
    [SPECIES_TORNADUS_THERIAN]     = BACK_ANIM_V_STRETCH,
    [SPECIES_THUNDURUS_THERIAN]    = BACK_ANIM_H_SLIDE,
    [SPECIES_LANDORUS_THERIAN]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_MELOETTA_PIROUETTE]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GENESECT_DOUSE_DRIVE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_GENESECT_SHOCK_DRIVE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_GENESECT_BURN_DRIVE]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_GENESECT_CHILL_DRIVE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ROCKRUFF_OWN_TEMPO]   = BACK_ANIM_V_STRETCH,
    [SPECIES_LYCANROC_DUSK]        = BACK_ANIM_V_SHAKE,
    [SPECIES_LYCANROC_MIDNIGHT]    = BACK_ANIM_SHRINK_GROW_VIBRATE,

    [SPECIES_BASCULEGION_FEMALE] = BACK_ANIM_JOLT_RIGHT,
    ...
    [SPECIES_ZORUA_HISUIAN]          = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_ZOROARK_HISUIAN]        = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_BRAVIARY_HISUIAN]       = BACK_ANIM_SHRINK_GROW_VIBRATE,
