const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN, ITEM_FARAWAY_STONE}},
    ...
    [SPECIES_POLIWHIRL]             = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                                       ...
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_POLITOED, ITEM_KINGS_ROCK}},
    ...
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                                       ...
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_SLOWKING, ITEM_KINGS_ROCK}},
    ...
    [SPECIES_ONIX]                  = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_STEELIX, ITEM_METAL_COAT}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN, ITEM_FARAWAY_STONE}},
    ...
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING},
                                       {EVO_LEVEL_ITEM_HOLD, 35, SPECIES_WEEZING_GALARIAN, ITEM_FARAWAY_STONE}},
    [SPECIES_RHYHORN]               = {{EVO_LEVEL, 42, SPECIES_RHYDON}},
    [SPECIES_RHYDON]                = {{EVO_TRADE_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_RHYPERIOR, ITEM_PROTECTOR}},
    ...
    [SPECIES_SEADRA]                = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_KINGDRA, ITEM_DRAGON_SCALE}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_SCIZOR, ITEM_METAL_COAT},
                                       {EVO_ITEM, ITEM_BLACK_AUGURITE, SPECIES_KLEAVOR}},
    [SPECIES_ELECTABUZZ]            = {{EVO_TRADE_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_ELECTIVIRE, ITEM_ELECTIRIZER}},
    [SPECIES_MAGMAR]                = {{EVO_TRADE_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_MAGMORTAR, ITEM_MAGMARIZER}},
    ...
    [SPECIES_PORYGON]               = {{EVO_TRADE_ITEM, ITEM_UPGRADE, SPECIES_PORYGON2},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_PORYGON2, ITEM_UPGRADE}},
    ...
    [SPECIES_QUILAVA]               = {{EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                       {EVO_LEVEL_ITEM_HOLD, 36, SPECIES_TYPHLOSION_HISUIAN, ITEM_FARAWAY_STONE}},
    ...
    [SPECIES_PORYGON2]              = {{EVO_TRADE_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_PORYGON_Z, ITEM_DUBIOUS_DISC}},
    ...
    [SPECIES_FEEBAS]                = {{EVO_BEAUTY, 170, SPECIES_MILOTIC},
                                       ...
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_MILOTIC, ITEM_PRISM_SCALE}},
    ...
    [SPECIES_DUSCLOPS]              = {{EVO_TRADE_ITEM, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_DUSKNOIR, ITEM_REAPER_CLOTH}},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_HUNTAIL, ITEM_DEEP_SEA_TOOTH},
                                       {EVO_TRADE_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_GOREBYSS, ITEM_DEEP_SEA_SCALE}},
    ...
    [SPECIES_DEWOTT]                = {{EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                       {EVO_LEVEL_ITEM_HOLD, 36, SPECIES_SAMUROTT_HISUIAN, ITEM_FARAWAY_STONE}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                      {EVO_ITEM_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUIAN, ITEM_FARAWAY_STONE}},
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_LEVEL_FEMALE, 30, SPECIES_BASCULEGION_FEMALE},
                                       {EVO_LEVEL_MALE, 30, SPECIES_BASCULEGION}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_TRADE_SPECIFIC_MON, SPECIES_SHELMET, SPECIES_ESCAVALIER},
                                       {EVO_ITEM, ITEM_LINK_CABLE, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_SHELMET]               = {{EVO_TRADE_SPECIFIC_MON, SPECIES_KARRABLAST, SPECIES_ACCELGOR},
                                       {EVO_ITEM, ITEM_LINK_CABLE, SPECIES_ACCELGOR}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY},
                                       {EVO_LEVEL_ITEM_HOLD, 54, SPECIES_BRAVIARY_HISUIAN, ITEM_FARAWAY_STONE}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_TRADE_ITEM, ITEM_SACHET, SPECIES_AROMATISSE},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_AROMATISSE, ITEM_SACHET}},
    [SPECIES_SWIRLIX]               = {{EVO_TRADE_ITEM, ITEM_WHIPPED_DREAM, SPECIES_SLURPUFF},
                                       {EVO_ITEM_ITEM, ITEM_LINK_CABLE, SPECIES_SLURPUFF, ITEM_WHIPPED_DREAM}},
    ...
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                       {EVO_LEVEL_ITEM_HOLD, 40, SPECIES_SLIGGOO_HISUIAN, ITEM_FARAWAY_STONE}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG},
                                       {EVO_LEVEL_ITEM_HOLD, 37, SPECIES_AVALUGG_HISUIAN, ITEM_FARAWAY_STONE}},
