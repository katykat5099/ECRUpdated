const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]               = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                                       ...
                                       {EVO_ITEM, ITEM_MOON_STONE/*CHANGE*/, SPECIES_KLEAVOR}},
    ...
    [SPECIES_URSARING]              = {{EVO_ITEM, ITEM_MOON_STONE/*Change*/, SPECIES_URSALUNA}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                      {EVO_ITEM_HOLD_DAY/*CHANGE*/, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUIAN}},
    ...
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                       {EVO_LEVEL, 40, SPECIES_SLIGGOO_HISUIAN}},
