...
static const u16 sBasculinForms[]       = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED};
static const u16 sFlabebeForms[]        = {SPECIES_FLABEBE, SPECIES_FLABEBE_YELLOW_FLOWER, SPECIES_FLABEBE_BLUE_FLOWER, SPECIES_FLABEBE_ORANGE_FLOWER, SPECIES_FLABEBE_WHITE_FLOWER};
static const u16 sFloetteForms[]        = {SPECIES_FLOETTE, SPECIES_FLOETTE_YELLOW_FLOWER, SPECIES_FLOETTE_BLUE_FLOWER, SPECIES_FLOETTE_ORANGE_FLOWER, SPECIES_FLOETTE_WHITE_FLOWER};
static const u16 sFlorgesForms[]        = {SPECIES_FLORGES, SPECIES_FLORGES_YELLOW_FLOWER, SPECIES_FLORGES_BLUE_FLOWER, SPECIES_FLORGES_ORANGE_FLOWER, SPECIES_FLORGES_WHITE_FLOWER};
static const u16 sDeerlingForms[]       = {SPECIES_DEERLING, SPECIES_DEERLING_AUTUMN, SPECIES_DEERLING_SUMMER, SPECIES_DEERLING_WINTER};
static const u16 sSawsbuckForms[]       = {SPECIES_SAWSBUCK, SPECIES_SAWSBUCK_AUTUMN, SPECIES_SAWSBUCK_SUMMER, SPECIES_SAWSBUCK_WINTER};
static const u16 sVivillonForms[]       = {SPECIES_VIVILLON, SPECIES_VIVILLON_POLAR, SPECIES_VIVILLON_TUNDRA, SPECIES_VIVILLON_CONTINENTAL, SPECIES_VIVILLON_GARDEN, SPECIES_VIVILLON_ELEGANT,
...
static const u16 sPumpkabooForms[]      = {SPECIES_PUMPKABOO, SPECIES_PUMPKABOO_SMALL, SPECIES_PUMPKABOO_LARGE, SPECIES_PUMPKABOO_SUPER};
static const u16 sGourgeistForms[]      = {SPECIES_GOURGEIST, SPECIES_GOURGEIST_SMALL, SPECIES_GOURGEIST_LARGE, SPECIES_GOURGEIST_SUPER};
static const u16 sMiniorForms[]         = {SPECIES_MINIOR, SPECIES_MINIOR_METEOR_BLUE, SPECIES_MINIOR_METEOR_GREEN, SPECIES_MINIOR_METEOR_INDIGO, SPECIES_MINIOR_METEOR_ORANGE,
                                           SPECIES_MINIOR_METEOR_VIOLET, SPECIES_MINIOR_METEOR_YELLOW};
static const u16 sCosplayPikachuForms[] = {SPECIES_PIKACHU_ROCK_STAR, SPECIES_PIKACHU_BELLE, SPECIES_PIKACHU_POP_STAR, SPECIES_PIKACHU_PH_D, SPECIES_PIKACHU_LIBRE,
                                           SPECIES_PIKACHU_ORIGINAL_CAP, SPECIES_PIKACHU_HOENN_CAP, SPECIES_PIKACHU_SINNOH_CAP, SPECIES_PIKACHU_UNOVA_CAP, SPECIES_PIKACHU_KALOS_CAP,
                                           SPECIES_PIKACHU_ALOLA_CAP, SPECIES_PIKACHU_PARTNER_CAP, SPECIES_PIKACHU_WORLD_CAP, SPECIES_PIKACHU_COSPLAY};
static const u16 sBurmyForms[]          = {SPECIES_BURMY, SPECIES_BURMY_SANDY_CLOAK, SPECIES_BURMY_TRASH_CLOAK};
static const u16 sWormadamForms[]       = {SPECIES_WORMADAM, SPECIES_WORMADAM_SANDY_CLOAK, SPECIES_WORMADAM_TRASH_CLOAK};
static const u16 sShellosForms[]        = {SPECIES_SHELLOS, SPECIES_SHELLOS_EAST_SEA};
static const u16 sGastrodonForms[]      = {SPECIES_GASTRODON, SPECIES_GASTRODON_EAST_SEA};
static const u16 sOricorioForms[]       = {SPECIES_ORICORIO, SPECIES_ORICORIO_POM_POM, SPECIES_ORICORIO_PAU, SPECIES_ORICORIO_SENSU};
static const u16 sRockruffForms[]       = {SPECIES_ROCKRUFF, SPECIES_ROCKRUFF_OWN_TEMPO};
static const u16 sLycanrocForms[]       = {SPECIES_LYCANROC, SPECIES_LYCANROC_MIDNIGHT, SPECIES_LYCANROC_DUSK};
static const u16 sToxtricityForms[]     = {SPECIES_TOXTRICITY, SPECIES_TOXTRICITY_LOW_KEY};
static const u16 sSinisteaForms[]       = {SPECIES_SINISTEA, SPECIES_SINISTEA_ANTIQUE};
static const u16 sPolteageistForms[]    = {SPECIES_POLTEAGEIST, SPECIES_POLTEAGEIST_ANTIQUE};
static const u16 sIndeedeeForms[]       = {SPECIES_INDEEDEE, SPECIES_INDEEDEE_FEMALE};
static const u16 sBasculegionForms[]    = {SPECIES_BASCULEGION, SPECIES_BASCULEGION_FEMALE};
static const u16 sMeowsticForms[]       = {SPECIES_MEOWSTIC, SPECIES_MEOWSTIC_FEMALE};
...
static void CreateWildMon(u16 species, u8 level)
{
    ...
    species = sCosplayPikachuForms[Random() % 14];
    break;
    case SPECIES_BURMY:
