...
static const u8 sBasculinForms[]  = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED};
static const u8 sFlabebeForms[]   = {SPECIES_FLABEBE, SPECIES_FLABEBE_YELLOW_FLOWER, SPECIES_FLABEBE_BLUE_FLOWER, SPECIES_FLABEBE_ORANGE_FLOWER, SPECIES_FLABEBE_WHITE_FLOWER};
static const u8 sFloetteForms[]   = {SPECIES_FLOETTE, SPECIES_FLOETTE_YELLOW_FLOWER, SPECIES_FLOETTE_BLUE_FLOWER, SPECIES_FLOETTE_ORANGE_FLOWER, SPECIES_FLOETTE_WHITE_FLOWER};
static const u8 sFlorgesForms[]   = {SPECIES_FLORGES, SPECIES_FLORGES_YELLOW_FLOWER, SPECIES_FLORGES_BLUE_FLOWER, SPECIES_FLORGES_ORANGE_FLOWER, SPECIES_FLORGES_WHITE_FLOWER};
static const u8 sDeerlingForms[]  = {SPECIES_DEERLING, SPECIES_DEERLING_AUTUMN, SPECIES_DEERLING_SUMMER, SPECIES_DEERLING_WINTER};
static const u8 sSawsbuckForms[]  = {SPECIES_SAWSBUCK, SPECIES_SAWSBUCK_AUTUMN, SPECIES_SAWSBUCK_SUMMER, SPECIES_SAWSBUCK_WINTER};
static const u8 sVivillonForms[]  = {SPECIES_VIVILLON, SPECIES_VIVILLON_POLAR, SPECIES_VIVILLON_TUNDRA, SPECIES_VIVILLON_CONTINENTAL, SPECIES_VIVILLON_GARDEN, SPECIES_VIVILLON_ELEGANT,
...
static const u8 sPumpkabooForms[] = {SPECIES_PUMPKABOO, SPECIES_PUMPKABOO_SMALL, SPECIES_PUMPKABOO_LARGE, SPECIES_PUMPKABOO_SUPER};
static const u8 sGourgeistForms[] = {SPECIES_GOURGEIST, SPECIES_GOURGEIST_SMALL, SPECIES_GOURGEIST_LARGE, SPECIES_GOURGEIST_SUPER};
static const u8 sMiniorForms[]    = {SPECIES_MINIOR, SPECIES_MINIOR_METEOR_BLUE, SPECIES_MINIOR_METEOR_GREEN, SPECIES_MINIOR_METEOR_INDIGO, SPECIES_MINIOR_METEOR_ORANGE,
