...
#endif
{
    ...
    [SPECIES_SPEAROW - 1]       = ANIM_V_JUMPS_BIG,
    ...
    // Gen 4
    [SPECIES_TURTWIG - 1]       = ANIM_V_STRETCH,
    [SPECIES_GROTLE - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_TORTERRA - 1]      = ANIM_H_SHAKE,
    [SPECIES_CHIMCHAR - 1]      = ANIM_H_STRETCH_FAR_SLOW,
    [SPECIES_MONFERNO - 1]      = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_INFERNAPE - 1]     = ANIM_H_STRETCH,
    [SPECIES_PIPLUP - 1]        = ANIM_V_STRETCH,
    [SPECIES_PRINPLUP - 1]      = ANIM_V_STRETCH,
    [SPECIES_EMPOLEON - 1]      = ANIM_H_STRETCH,
    [SPECIES_STARLY - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STARAVIA - 1]      = ANIM_V_STRETCH,
    [SPECIES_STARAPTOR - 1]     = ANIM_V_STRETCH,
    [SPECIES_BIDOOF - 1]        = ANIM_V_STRETCH,
    [SPECIES_BIBAREL - 1]       = ANIM_V_STRETCH,
    [SPECIES_KRICKETOT - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_KRICKETUNE - 1]    = ANIM_H_STRETCH,
    [SPECIES_SHINX - 1]         = ANIM_V_STRETCH,
    [SPECIES_LUXIO - 1]         = ANIM_V_STRETCH,
    [SPECIES_LUXRAY - 1]        = ANIM_FLASH_YELLOW,
    [SPECIES_BUDEW - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_DRIFBLIM - 1]      = ANIM_V_SLIDE_WOBBLE,//Custom
    [SPECIES_BUNEARY - 1]       = ANIM_V_JUMPS_BIG,
    [SPECIES_LOPUNNY - 1]       = ANIM_V_SQUISH_AND_BOUNCE,//DP
    [SPECIES_MISMAGIUS - 1]     = ANIM_SWING_CONVEX_FAST,
    [SPECIES_HONCHKROW - 1]     = ANIM_GLOW_BLACK,
    [SPECIES_GLAMEOW - 1]       = ANIM_V_STRETCH,//PL
    [SPECIES_PURUGLY - 1]       = ANIM_SHRINK_GROW,//DP
    ...
    [SPECIES_BRONZOR - 1]       = ANIM_H_SLIDE_WOBBLE,//DP
    ...
    [SPECIES_CHATOT - 1]        = ANIM_H_JUMPS,//PL
    [SPECIES_SPIRITOMB - 1]     = ANIM_CIRCULAR_STRETCH_TWICE,//DP
    [SPECIES_GIBLE - 1]         = ANIM_V_JUMPS_BIG,
    [SPECIES_GABITE - 1]        = ANIM_V_STRETCH,
    [SPECIES_GARCHOMP - 1]      = ANIM_V_SHAKE_TWICE,//DP
    ...
    [SPECIES_UXIE - 1]          = ANIM_H_SLIDE_WOBBLE,//Custom
    [SPECIES_MESPRIT - 1]       = ANIM_SWING_CONCAVE,//PL
    [SPECIES_AZELF - 1]         = ANIM_H_SLIDE_WOBBLE,//PL
    [SPECIES_DIALGA - 1]        = ANIM_V_SHAKE,//PL
    [SPECIES_PALKIA - 1]        = ANIM_V_SHAKE_TWICE,//PL
    [SPECIES_HEATRAN - 1]       = ANIM_GLOW_RED,
    [SPECIES_REGIGIGAS - 1]     = ANIM_H_SHAKE,//PL
    [SPECIES_GIRATINA - 1]      = ANIM_H_SHAKE,//Custom
    [SPECIES_CRESSELIA - 1]     = ANIM_V_SLIDE_SLOW,//PL
    [SPECIES_PHIONE - 1]        = ANIM_H_SLIDE_WOBBLE,//PL
    [SPECIES_MANAPHY - 1]       = ANIM_SWING_CONCAVE,//PL
    [SPECIES_DARKRAI - 1]       = ANIM_H_SHAKE_FAST,//PL
    [SPECIES_SHAYMIN - 1]       = ANIM_V_STRETCH,//PL
    [SPECIES_ARCEUS - 1]        = ANIM_H_SHAKE_FAST,//DP

    // Gen 5 Todo: Assign proper ones.
    [SPECIES_VICTINI - 1]       = ANIM_BOUNCE_ROTATE_TO_SIDES,
    [SPECIES_SNIVY - 1]         = ANIM_H_STRETCH_FAR_SLOW,
    [SPECIES_SERVINE - 1]       = ANIM_TIP_MOVE_FORWARD,
    [SPECIES_SERPERIOR - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_TEPIG - 1]         = ANIM_GROW_VIBRATE,
    [SPECIES_PIGNITE - 1]       = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_EMBOAR - 1]        = ANIM_V_SHAKE,
    [SPECIES_OSHAWOTT - 1]      = ANIM_TIP_HOP_FORWARD,
    [SPECIES_DEWOTT - 1]        = ANIM_H_STRETCH,
    [SPECIES_SAMUROTT - 1]      = ANIM_GROW_IN_STAGES,
    [SPECIES_PATRAT - 1]        = ANIM_H_SLIDE,
    [SPECIES_WATCHOG - 1]       = ANIM_H_SLIDE_SLOW,
    [SPECIES_LILLIPUP - 1]      = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_HERDIER - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_STOUTLAND - 1]     = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_PURRLOIN - 1]      = ANIM_GROW_VIBRATE,
    [SPECIES_LIEPARD - 1]       = ANIM_GLOW_BLACK,
    [SPECIES_PANSAGE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SIMISAGE - 1]      = ANIM_SHAKE_GLOW_GREEN_SLOW,
    [SPECIES_PANSEAR - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SIMISEAR - 1]      = ANIM_SHAKE_GLOW_RED_FAST,
    [SPECIES_PANPOUR - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SIMIPOUR - 1]      = ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_MUNNA - 1]         = ANIM_SWING_CONVEX,
    [SPECIES_MUSHARNA - 1]      = ANIM_SWING_CONVEX,
    [SPECIES_PIDOVE - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_TRANQUILL - 1]     = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_UNFEZANT - 1]      = ANIM_V_STRETCH,
    [SPECIES_BLITZLE - 1]       = ANIM_GLOW_YELLOW,
    [SPECIES_ZEBSTRIKA - 1]     = ANIM_H_SHAKE,
    [SPECIES_ROGGENROLA - 1]    = ANIM_SWING_CONCAVE,
    [SPECIES_BOLDORE - 1]       = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_GIGALITH - 1]      = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_WOOBAT - 1]        = ANIM_RISING_WOBBLE,
    [SPECIES_SWOOBAT - 1]       = ANIM_ZIGZAG_FAST,
    [SPECIES_DRILBUR - 1]       = ANIM_BOUNCE_ROTATE_TO_SIDES,
    [SPECIES_EXCADRILL - 1]     = ANIM_H_SHAKE,
    [SPECIES_AUDINO - 1]        = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_TIMBURR - 1]       = ANIM_H_JUMPS_V_STRETCH_TWICE,
    [SPECIES_GURDURR - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_CONKELDURR - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_TYMPOLE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PALPITOAD - 1]     = ANIM_H_SLIDE,
    [SPECIES_SEISMITOAD - 1]    = ANIM_GROW_STUTTER_SLOW,
    [SPECIES_THROH - 1]         = ANIM_H_STRETCH,
    [SPECIES_SAWK - 1]          = ANIM_V_STRETCH,
    [SPECIES_SEWADDLE - 1]      = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_SWADLOON - 1]      = ANIM_GLOW_ORANGE,
    [SPECIES_LEAVANNY - 1]      = ANIM_FIGURE_8,
    [SPECIES_VENIPEDE - 1]      = ANIM_H_SLIDE,
    [SPECIES_WHIRLIPEDE - 1]    = ANIM_SPIN,
    [SPECIES_SCOLIPEDE - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_COTTONEE - 1]      = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_WHIMSICOTT - 1]    = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_PETILIL - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LILLIGANT - 1]     = ANIM_SWING_CONCAVE,
    [SPECIES_BASCULIN - 1]      = ANIM_RISING_WOBBLE,
    [SPECIES_SANDILE - 1]       = ANIM_SHRINK_GROW,
    [SPECIES_KROKOROK - 1]      = ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_KROOKODILE - 1]    = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_DARUMAKA - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_DARMANITAN - 1]    = ANIM_BACK_AND_LUNGE,
    [SPECIES_MARACTUS - 1]      = ANIM_CIRCLE_INTO_BG,
    [SPECIES_DWEBBLE - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_CRUSTLE - 1]       = ANIM_RAPID_H_HOPS,
    [SPECIES_SCRAGGY - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_SCRAFTY - 1]       = ANIM_GLOW_BLACK,
    [SPECIES_SIGILYPH - 1]      = ANIM_SWING_CONVEX,
    [SPECIES_YAMASK - 1]        = ANIM_RISING_WOBBLE,
    [SPECIES_COFAGRIGUS - 1]    = ANIM_H_VIBRATE,
    [SPECIES_TIRTOUGA - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_CARRACOSTA - 1]    = ANIM_SHRINK_GROW_SLOW,
    [SPECIES_ARCHEN - 1]        = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_ARCHEOPS - 1]      = ANIM_RISING_WOBBLE,
    [SPECIES_TRUBBISH - 1]      = ANIM_H_SLIDE_SLOW,
    [SPECIES_GARBODOR - 1]      = ANIM_SHAKE_GLOW_PURPLE_SLOW,
    [SPECIES_ZORUA - 1]         = ANIM_GROW_VIBRATE,
    [SPECIES_ZOROARK - 1]       = ANIM_H_VIBRATE,
    [SPECIES_MINCCINO - 1]      = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_CINCCINO - 1]      = ANIM_H_JUMPS,
    [SPECIES_GOTHITA - 1]       = ANIM_FIGURE_8,
    [SPECIES_GOTHORITA - 1]     = ANIM_SHRINK_GROW,
    [SPECIES_GOTHITELLE - 1]    = ANIM_FLICKER_INCREASING,
    [SPECIES_SOLOSIS - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_DUOSION - 1]       = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_REUNICLUS - 1]     = ANIM_SWING_CONVEX,
    [SPECIES_DUCKLETT - 1]      = ANIM_GLOW_BLUE,
    [SPECIES_SWANNA - 1]        = ANIM_H_SLIDE_SLOW,
    [SPECIES_VANILLITE - 1]     = ANIM_CONVEX_DOUBLE_ARC_SLOW,
    [SPECIES_VANILLISH - 1]     = ANIM_RISING_WOBBLE,
    [SPECIES_VANILLUXE - 1]     = ANIM_H_SLIDE_SLOW,
    [SPECIES_DEERLING - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_SAWSBUCK - 1]      = ANIM_V_STRETCH,
    [SPECIES_EMOLGA - 1]        = ANIM_ZIGZAG_SLOW,
    [SPECIES_KARRABLAST - 1]    = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_ESCAVALIER - 1]    = ANIM_H_SLIDE,
    [SPECIES_FOONGUS - 1]       = ANIM_GLOW_ORANGE,
    [SPECIES_AMOONGUSS - 1]     = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_FRILLISH - 1]      = ANIM_RISING_WOBBLE,
    [SPECIES_JELLICENT - 1]     = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_ALOMOMOLA - 1]     = ANIM_RISING_WOBBLE,
    [SPECIES_JOLTIK - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_GALVANTULA - 1]    = ANIM_SHAKE_FLASH_YELLOW_FAST,
    [SPECIES_FERROSEED - 1]     = ANIM_H_VIBRATE,
    [SPECIES_FERROTHORN - 1]    = ANIM_V_STRETCH_BOTH_ENDS_SLOW,
    [SPECIES_KLINK - 1]         = ANIM_V_SLIDE_SLOW,
    [SPECIES_KLANG - 1]         = ANIM_V_SLIDE,
    [SPECIES_KLINKLANG - 1]     = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_TYNAMO - 1]        = ANIM_V_SLIDE,
    [SPECIES_EELEKTRIK - 1]     = ANIM_FLASH_YELLOW,
    [SPECIES_EELEKTROSS - 1]    = ANIM_SHAKE_FLASH_YELLOW_SLOW,
    [SPECIES_ELGYEM - 1]        = ANIM_ZIGZAG_FAST,
    [SPECIES_BEHEEYEM - 1]      = ANIM_RISING_WOBBLE,
    [SPECIES_LITWICK - 1]       = ANIM_V_STRETCH,
    [SPECIES_LAMPENT - 1]       = ANIM_SWING_CONVEX,
    [SPECIES_CHANDELURE - 1]    = ANIM_SWING_CONVEX,
    [SPECIES_AXEW - 1]          = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_FRAXURE - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_HAXORUS - 1]       = ANIM_V_SHAKE_TWICE,
    [SPECIES_CUBCHOO - 1]       = ANIM_H_SLIDE,
    [SPECIES_BEARTIC - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_CRYOGONAL - 1]     = ANIM_SWING_CONVEX,
    [SPECIES_SHELMET - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_ACCELGOR - 1]      = ANIM_V_SHAKE,
    [SPECIES_STUNFISK - 1]      = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_MIENFOO - 1]       = ANIM_CONCAVE_ARC_SMALL_TWICE,
    [SPECIES_MIENSHAO - 1]      = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_DRUDDIGON - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_GOLETT - 1]        = ANIM_H_SHAKE,
    [SPECIES_GOLURK - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_PAWNIARD - 1]      = ANIM_H_SLIDE_SLOW,
    [SPECIES_BISHARP - 1]       = ANIM_H_VIBRATE,
    [SPECIES_BOUFFALANT - 1]    = ANIM_JOLT_RIGHT_SLOW,
    [SPECIES_RUFFLET - 1]       = ANIM_V_STRETCH,
    [SPECIES_BRAVIARY - 1]      = ANIM_CONVEX_DOUBLE_ARC_SLOW,
    [SPECIES_VULLABY - 1]       = ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MANDIBUZZ - 1]     = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_HEATMOR - 1]       = ANIM_SHAKE_GLOW_RED_SLOW,
    [SPECIES_DURANT - 1]        = ANIM_BACK_AND_LUNGE,
    [SPECIES_DEINO - 1]         = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_ZWEILOUS - 1]      = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_HYDREIGON - 1]     = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_LARVESTA - 1]      = ANIM_BACK_FLIP_BIG,
    [SPECIES_VOLCARONA - 1]     = ANIM_CONCAVE_ARC_SMALL_SLOW,
    [SPECIES_COBALION - 1]      = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_TERRAKION - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_VIRIZION - 1]      = ANIM_H_VIBRATE_FASTEST,
    [SPECIES_TORNADUS - 1]      = ANIM_CONVEX_DOUBLE_ARC_SLOW,
    [SPECIES_THUNDURUS - 1]     = ANIM_CONVEX_DOUBLE_ARC_SLOW,
    [SPECIES_RESHIRAM - 1]      = ANIM_SHAKE_GLOW_RED_SLOW,
    [SPECIES_ZEKROM - 1]        = ANIM_SHAKE_FLASH_YELLOW_FAST,
    [SPECIES_LANDORUS - 1]      = ANIM_CONVEX_DOUBLE_ARC_SLOW,
    [SPECIES_KYUREM - 1]        = ANIM_SHAKE_GLOW_WHITE_SLOW,
    [SPECIES_KELDEO - 1]        = ANIM_V_STRETCH,
    [SPECIES_MELOETTA - 1]      = ANIM_GROW_VIBRATE,
    [SPECIES_GENESECT - 1]      = ANIM_H_VIBRATE,

    //Gen 6
    [SPECIES_CHESPIN - 1]       = ANIM_V_STRETCH,
    [SPECIES_QUILLADIN - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHESNAUGHT - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_FENNEKIN - 1]      = ANIM_V_STRETCH,
    [SPECIES_BRAIXEN - 1]       = ANIM_SHAKE_GLOW_RED_SLOW,
    [SPECIES_DELPHOX - 1]       = ANIM_V_STRETCH,
    [SPECIES_FROAKIE - 1]       = ANIM_H_STRETCH,
    ...
    [SPECIES_LITLEO - 1]        = ANIM_H_STRETCH,
    [SPECIES_PYROAR - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_FLABEBE - 1]       = ANIM_SWING_CONVEX,
    ...
    [SPECIES_PANCHAM - 1]       = ANIM_CONCAVE_ARC_SMALL_TWICE,
    [SPECIES_PANGORO - 1]       = ANIM_V_STRETCH_BOTH_ENDS_SLOW,
    ...
    [SPECIES_MALAMAR - 1]       = ANIM_CIRCULAR_VIBRATE,
    ...
    [SPECIES_HELIOPTILE - 1]    = ANIM_FLASH_YELLOW,
    [SPECIES_HELIOLISK - 1]     = ANIM_H_SLIDE,
    ...
    [SPECIES_TOUCANNON - 1]     = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    ...
    [SPECIES_KOMMO_O - 1]       = ANIM_H_SHAKE,
    ...
    [SPECIES_GROOKEY - 1]       = ANIM_CIRCULAR_STRETCH_TWICE,
    ...
    [SPECIES_APPLIN - 1]        = ANIM_V_STRETCH,
    [SPECIES_FLAPPLE - 1]       = ANIM_V_SLIDE,
    [SPECIES_APPLETUN - 1]      = ANIM_V_SHAKE_TWICE,
    ...
    [SPECIES_DRACOVISH - 1]     = ANIM_H_SHAKE,
    [SPECIES_ARCTOVISH - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DURALUDON - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DREEPY - 1]        = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_DRAKLOAK - 1]      = ANIM_FIGURE_8,
    [SPECIES_DRAGAPULT - 1]     = ANIM_FLICKER_INCREASING,
    ...
    [SPECIES_BASCULEGION - 1]   = ANIM_BACK_AND_LUNGE,
    ...
    [SPECIES_DEERLING_SUMMER - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_DEERLING_AUTUMN - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_DEERLING_WINTER - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_SAWSBUCK_SUMMER - 1]      = ANIM_V_STRETCH,
    [SPECIES_SAWSBUCK_AUTUMN - 1]      = ANIM_V_STRETCH,
    [SPECIES_SAWSBUCK_WINTER - 1]      = ANIM_V_STRETCH,
    [SPECIES_KYUREM_WHITE - 1]         = ANIM_SHAKE_GLOW_RED_SLOW,
    [SPECIES_KYUREM_BLACK - 1]         = ANIM_SHAKE_FLASH_YELLOW_FAST,
    [SPECIES_KELDEO_RESOLUTE - 1]      = ANIM_V_STRETCH,
    [SPECIES_TORNADUS_THERIAN - 1]     = ANIM_V_STRETCH,
    [SPECIES_THUNDURUS_THERIAN - 1]    = ANIM_H_SLIDE_SLOW,
    [SPECIES_LANDORUS_THERIAN - 1]     = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    [SPECIES_MELOETTA_PIROUETTE - 1]   = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_VIVILLON_POLAR - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_TUNDRA - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_CONTINENTAL - 1] = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_GARDEN - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_ELEGANT - 1]     = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_MEADOW - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_MODERN - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_MARINE - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_ARCHIPELAGO - 1] = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_HIGH_PLAINS - 1] = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_SANDSTORM - 1]   = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_RIVER - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_MONSOON - 1]     = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_SAVANNA - 1]     = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_SUN - 1]         = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_OCEAN - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_JUNGLE - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_FANCY - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_VIVILLON_POKE_BALL - 1]   = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_FLABEBE_YELLOW_FLOWER - 1] = ANIM_SWING_CONVEX,
    [SPECIES_FLABEBE_ORANGE_FLOWER - 1] = ANIM_SWING_CONVEX,
    [SPECIES_FLABEBE_BLUE_FLOWER - 1]   = ANIM_SWING_CONVEX,
    [SPECIES_FLABEBE_WHITE_FLOWER - 1]  = ANIM_SWING_CONVEX,
    [SPECIES_FLOETTE_YELLOW_FLOWER - 1] = ANIM_SWING_CONVEX,
    [SPECIES_FLOETTE_BLUE_FLOWER - 1]   = ANIM_SWING_CONVEX,
    [SPECIES_FLOETTE_WHITE_FLOWER - 1]  = ANIM_SWING_CONVEX,
    [SPECIES_FLOETTE_ETERNAL_FLOWER - 1] = ANIM_SWING_CONVEX, // No Anim Front
    ...
    [SPECIES_PUMPKABOO_SMALL - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_PUMPKABOO_LARGE - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_PUMPKABOO_SUPER - 1]       = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_GOURGEIST_SMALL - 1]       = ANIM_SWING_CONVEX,
    [SPECIES_GOURGEIST_LARGE - 1]       = ANIM_SWING_CONVEX,
    [SPECIES_GOURGEIST_SUPER - 1]       = ANIM_SWING_CONVEX,
    ...
    [SPECIES_BASCULEGION_FEMALE - 1]     = ANIM_SWING_CONVEX,
    [SPECIES_BASCULIN_WHITE_STRIPED - 1] = ANIM_RISING_WOBBLE,
    [SPECIES_BASCULIN_BLUE_STRIPED - 1]  = ANIM_RISING_WOBBLE,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_SPIRITOMB - 1]  = 20,
    [SPECIES_GARCHOMP - 1]   = 20,
    [SPECIES_HIPPOPOTAS - 1] = 8,
    [SPECIES_DIALGA - 1]     = 10,
    [SPECIES_REGIGIGAS - 1]  = 30,
    [SPECIES_SHAYMIN - 1]    = 30,
    [SPECIES_ARCEUS - 1]     = 15,
    [SPECIES_DEWOTT - 1]     = 20,
    [SPECIES_CONKELDURR - 1] = 5,
    [SPECIES_TYMPOLE - 1]    = 15,
    [SPECIES_TERRAKION - 1]  = 10,
    [SPECIES_VIRIZION - 1]   = 15,
    [SPECIES_TRUMBEAK - 1]   = 20,
    [SPECIES_ROCKRUFF - 1]   = 5,
    [SPECIES_TAPU_FINI - 1]  = 5,
    [SPECIES_APPLETUN - 1]   = 20,
    [SPECIES_ROTOM_FAN - 1]  = 7,
    [SPECIES_BRAVIARY_HISUIAN - 1] = 15,
};
...
static const u8 gSpeciesMapping[NUM_SPECIES+1] =
{
    ...
    [SPECIES_BASCULEGION_FEMALE] = EVO_TYPE_1,
    [SPECIES_BASCULIN_WHITE_STRIPED] = EVO_TYPE_0,
...
static const u16 sRandomSpecies3StageEvoStarters[] =
{
    ...
    SPECIES_MAGNEMITE       ,    // Magneton, Magnezone
    ...
    SPECIES_SWINUB          ,    // Piloswine, Mamoswine
    ...
    SPECIES_DUSKULL         ,    // Dusklops, Dusknoir
    ...
    SPECIES_MIME_JR           , // Mr. Mime, Mr. Rime
    ...
    SPECIES_LILLIPUP          , // Herdier, Stoutland
...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_GROWLITHE ... SPECIES_ARCANINE]    = {SPECIES_GROWLITHE, SPECIES_ARCANINE, SPECIES_GROWLITHE_HISUIAN, SPECIES_ARCANINE_HISUIAN},
    [SPECIES_GROWLITHE_HISUIAN]                 = {SPECIES_GROWLITHE, SPECIES_ARCANINE, SPECIES_GROWLITHE_HISUIAN, SPECIES_ARCANINE_HISUIAN},
    [SPECIES_ARCANINE_HISUIAN]                  = {SPECIES_GROWLITHE, SPECIES_ARCANINE, SPECIES_GROWLITHE_HISUIAN, SPECIES_ARCANINE_HISUIAN},
    ...
    [SPECIES_VOLTORB ... SPECIES_ELECTRODE]     = {SPECIES_VOLTORB, SPECIES_ELECTRODE, SPECIES_VOLTORB_HISUIAN, SPECIES_ELECTRODE_HISUIAN},
    [SPECIES_VOLTORB_HISUIAN]                   = {SPECIES_VOLTORB, SPECIES_ELECTRODE, SPECIES_VOLTORB_HISUIAN, SPECIES_ELECTRODE_HISUIAN},
    [SPECIES_ELECTRODE_HISUIAN]                 = {SPECIES_VOLTORB, SPECIES_ELECTRODE, SPECIES_VOLTORB_HISUIAN, SPECIES_ELECTRODE_HISUIAN},
    #ifdef POKEMON_EXPANSION
    ...
    [SPECIES_CYNDAQUIL ... SPECIES_TYPHLOSION]  = {SPECIES_CYNDAQUIL, SPECIES_QUILAVA, SPECIES_TYPHLOSION, SPECIES_TYPHLOSION_HISUIAN},
    [SPECIES_TYPHLOSION_HISUIAN]                = {SPECIES_CYNDAQUIL, SPECIES_QUILAVA, SPECIES_TYPHLOSION, SPECIES_TYPHLOSION_HISUIAN},
    ...
    [SPECIES_QWILFISH]                          = {SPECIES_QWILFISH, SPECIES_QWILFISH_HISUIAN, SPECIES_OVERQWIL},
    [SPECIES_QWILFISH_HISUIAN]                  = {SPECIES_QWILFISH, SPECIES_QWILFISH_HISUIAN, SPECIES_OVERQWIL},
    [SPECIES_OVERQWIL]                          = {SPECIES_QWILFISH, SPECIES_QWILFISH_HISUIAN, SPECIES_OVERQWIL},
    #ifdef POKEMON_EXPANSION
    [SPECIES_SNEASEL]                           = {SPECIES_SNEASEL, SPECIES_WEAVILE, SPECIES_SNEASEL_HISUIAN, SPECIES_SNEASLER},
    [SPECIES_WEAVILE]                           = {SPECIES_SNEASEL, SPECIES_WEAVILE, SPECIES_SNEASEL_HISUIAN, SPECIES_SNEASLER},
    [SPECIES_SNEASEL_HISUIAN]                   = {SPECIES_SNEASEL, SPECIES_WEAVILE, SPECIES_SNEASEL_HISUIAN, SPECIES_SNEASLER},
    #endif
    ...
    [SPECIES_OSHAWOTT ... SPECIES_SAMUROTT]     = {SPECIES_OSHAWOTT, SPECIES_DEWOTT, SPECIES_SAMUROTT, SPECIES_SAMUROTT_HISUIAN},
    [SPECIES_SAMUROTT_HISUIAN]                  = {SPECIES_OSHAWOTT, SPECIES_DEWOTT, SPECIES_SAMUROTT, SPECIES_SAMUROTT_HISUIAN},
    ...
    [SPECIES_PETILIL ... SPECIES_LILLIGANT]     = {SPECIES_PETILIL, SPECIES_LILLIGANT, SPECIES_LILLIGANT_HISUIAN},
    [SPECIES_LILLIGANT_HISUIAN]                 = {SPECIES_PETILIL, SPECIES_LILLIGANT, SPECIES_LILLIGANT_HISUIAN},
    [SPECIES_BASCULIN]                          = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_BASCULEGION, SPECIES_BASCULEGION_FEMALE},
    [SPECIES_BASCULIN_BLUE_STRIPED]             = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_BASCULEGION, SPECIES_BASCULEGION_FEMALE},
    [SPECIES_BASCULIN_WHITE_STRIPED]            = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_BASCULEGION, SPECIES_BASCULEGION_FEMALE},
    [SPECIES_BASCULEGION_FEMALE]                = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_BASCULEGION, SPECIES_BASCULEGION_FEMALE},
    [SPECIES_BASCULEGION]                       = {SPECIES_BASCULIN, SPECIES_BASCULIN_BLUE_STRIPED, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_BASCULEGION, SPECIES_BASCULEGION_FEMALE},
    ...
    [SPECIES_ZORUA ... SPECIES_ZOROARK]         = {SPECIES_ZORUA, SPECIES_ZOROARK, SPECIES_ZORUA_HISUIAN, SPECIES_ZOROARK_HISUIAN},
    [SPECIES_ZORUA_HISUIAN]                     = {SPECIES_ZORUA, SPECIES_ZOROARK, SPECIES_ZORUA_HISUIAN, SPECIES_ZOROARK_HISUIAN},
    [SPECIES_ZOROARK_HISUIAN]                   = {SPECIES_ZORUA, SPECIES_ZOROARK, SPECIES_ZORUA_HISUIAN, SPECIES_ZOROARK_HISUIAN},
    ...
    [SPECIES_RUFFLET ... SPECIES_BRAVIARY]      = {SPECIES_RUFFLET, SPECIES_BRAVIARY, SPECIES_BRAVIARY_HISUIAN},
    [SPECIES_BRAVIARY_HISUIAN]                  = {SPECIES_RUFFLET, SPECIES_BRAVIARY, SPECIES_BRAVIARY_HISUIAN},
    ...
    [SPECIES_GOOMY ... SPECIES_GOODRA]          = {SPECIES_GOOMY, SPECIES_SLIGGOO, SPECIES_GOODRA, SPECIES_SLIGGOO_HISUIAN, SPECIES_GOODRA_HISUIAN},
    [SPECIES_SLIGGOO_HISUIAN]                   = {SPECIES_GOOMY, SPECIES_SLIGGOO, SPECIES_GOODRA, SPECIES_SLIGGOO_HISUIAN, SPECIES_GOODRA_HISUIAN},
    [SPECIES_GOODRA_HISUIAN]                    = {SPECIES_GOOMY, SPECIES_SLIGGOO, SPECIES_GOODRA, SPECIES_SLIGGOO_HISUIAN, SPECIES_GOODRA_HISUIAN},
    ...
    [SPECIES_PUMPKABOO_SMALL ... SPECIES_GOURGEIST_SUPER] = {SPECIES_PUMPKABOO, SPECIES_GOURGEIST,
                                                    ...
                                                    SPECIES_PUMPKABOO_LARGE, SPECIES_GOURGEIST_LARGE,
                                                    SPECIES_PUMPKABOO_SUPER, SPECIES_GOURGEIST_SUPER},
    [SPECIES_BERGMITE ... SPECIES_AVALUGG]      = {SPECIES_BERGMITE, SPECIES_AVALUGG, SPECIES_AVALUGG_HISUIAN},
    [SPECIES_AVALUGG_HISUIAN]                   = {SPECIES_BERGMITE, SPECIES_AVALUGG, SPECIES_AVALUGG_HISUIAN},
    ...
    [SPECIES_ROWLET ... SPECIES_DECIDUEYE]      = {SPECIES_ROWLET, SPECIES_DARTRIX, SPECIES_DECIDUEYE, SPECIES_DECIDUEYE_HISUIAN},
    [SPECIES_DECIDUEYE_HISUIAN]                 = {SPECIES_ROWLET, SPECIES_DARTRIX, SPECIES_DECIDUEYE, SPECIES_DECIDUEYE_HISUIAN},
...
u16 CheckPartyMegaPokemon(void)
{
    s8 i;
    s16 megaIndex = 0;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BULBASAUR || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_IVYSAUR || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_VENUSAUR)
        {
            megaIndex = 1;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_CHARMANDER || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_CHARMELEON || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_CHARIZARD)
        {
            megaIndex = 2;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SQUIRTLE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_WARTORTLE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BLASTOISE)
        {
            megaIndex = 3;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ABRA || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_KADABRA || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ALAKAZAM)
        {
            megaIndex = 4;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GASTLY || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_HAUNTER || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GENGAR)
        {
            megaIndex = 5;
            return megaIndex;
        }
        ...
        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MAGIKARP || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GYARADOS)
        {
            megaIndex = 8;
            return megaIndex;
        }
        ...
        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MAREEP || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_FLAAFFY || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_AMPHAROS)
        {
            megaIndex = 11;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SCYTHER || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SCIZOR)
        {
            megaIndex = 12;
            return megaIndex;
        }
        ...
        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_HOUNDOUR || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_HOUNDOOM)
        {
            megaIndex = 14;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_LARVITAR || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_PUPITAR || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_TYRANITAR)
        {
            megaIndex = 15;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_TORCHIC || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_COMBUSKEN || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BLAZIKEN)
        {
            megaIndex = 16;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_RALTS || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_KIRLIA || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GARDEVOIR || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GALLADE)
        {
            megaIndex = 17;
            return megaIndex;
        }
        ...
        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ARON || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_LAIRON || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_AGGRON)
        {
            megaIndex = 19;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MEDITITE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MEDICHAM)
        {
            megaIndex = 20;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ELECTRIKE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MANECTRIC)
        {
            megaIndex = 21;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SHUPPET || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BANETTE)
        {
            megaIndex = 22;
            return megaIndex;
        }
        ...
        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GIBLE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GABITE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GARCHOMP)
        {
            megaIndex = 26;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_RIOLU || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_LUCARIO)
        {
            megaIndex = 27;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SNOVER || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ABOMASNOW)
        {
            megaIndex = 28;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_WEEDLE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_KAKUNA || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BEEDRILL)
        {
            megaIndex = 29;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_PIDGEY || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_PIDGEOTTO || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_PIDGEOT)
        {
            megaIndex = 30;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SLOWPOKE ||  GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) ==SPECIES_SLOWBRO)
        {
            megaIndex = 31;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ONIX || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_STEELIX)
        {
            megaIndex = 32;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_TREECKO || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GROVYLE || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SCEPTILE)
        {
            megaIndex = 33;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MUDKIP || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MARSHTOMP || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SWAMPERT)
        {
            megaIndex = 34;
            return megaIndex;
        }
        ...
        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_CARVANHA || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SHARPEDO)
        {
            megaIndex = 36;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_NUMEL || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_CAMERUPT)
        {
            megaIndex = 37;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SWABLU || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ALTARIA)
        {
            megaIndex = 38;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SNORUNT || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GLALIE)
        {
            megaIndex = 39;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BAGON || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SHELGON || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SALAMENCE)
        {
            megaIndex = 40;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BAGON || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_METANG || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_METAGROSS)
        {
            megaIndex = 41;
            return megaIndex;
        }

        else if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BUNEARY || GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_LOPUNNY)
        {
            megaIndex = 42;
            return megaIndex;
        }
